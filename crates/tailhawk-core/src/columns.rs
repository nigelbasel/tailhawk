...
mod tests {
    ...
    fn widths_come_from_the_sample_and_the_last_column_is_the_rest_of_the_row() {
        let layout = serilog();
        // "2026-08-16 09:14:02.117 +02:00" is 30 cells; the level is 3; the message is open.
        assert_eq!(layout.widths, [30, 3, 0]);
        assert_eq!(layout.message_indent(), 30 + GAP + 3 + GAP);
    }
