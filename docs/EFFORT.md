...
| 2026-08-17 | 1.6⁴ | 330 k⁴ | 8 | The find harness run at last; E23 catalogue + derived colours, wired beneath matches, on screen; E14 library half — `sieve.rs`, the shared pass, the 10 GB filter criterion |
| **Total** | **~38.7** | **~7.6 M** | **141**³ | **M0–M4, plus 7 of M5's 10 items and half of an eighth** |
